...
public interface IWeightCommunicator {
	public enum Buttons {
		...
		LOGOUT, /*
				 * When the user dosen't want to do anymore measurement. K R 3
				 */
		NULL /* Standard value. */
	}
	 ...
	 * 
	 * @param Message
	 *            wished message to show on weight display
	...
	/**
	 * Clears the display on the weight and all currently ongoing functions.
	 * Then resets the weight to its begin-state.
	 */
